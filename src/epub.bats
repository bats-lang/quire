(* epub -- EPUB import pipeline for quire *)
...
(* ============================================================
   OPF metadata walking — find dc:title and dc:creator
   Returns (title_off, title_len, author_off, author_len)
   ============================================================ *)
...
(* ============================================================
   Copy bytes from borrow into arr
   ============================================================ *)
...
(* ============================================================
   ZIP entry search — find entry by literal name
   ============================================================ *)
...
(* Find entry by matching name bytes from a borrow *)
...
(* ============================================================
   Copy bytes from arr to arr (via freeze/borrow)
   ============================================================ *)
...
(* ============================================================
   Import pipeline — main entry point
   ============================================================ *)

#pub fn import_epub
  (node_id: int): $P.promise(int, $P.Chained)

implement import_epub(node_id) = let
      ...
      in
        ...
        in
          ...
          in $P.ret<int>(~4) end
            ...
            (* Copy compressed container.xml data *)
            ...
            val dc_p = $P.vow(dc_p)
            (* Capture file_buf, cd_off, cd_count for next stage *)
          in
            ...
            in
              ...
              in
                ...
                in $P.ret<int>(~6) end
                  ...
                  (* Copy .opf path into separate buffer *)
                    ...
                    in
                      ...
                      in
                        ...
                        in $P.ret<int>(~9) end
                          ...
                          (* meta = (title_off, title_len, author_off, author_len) *)
